...
### Creación de una IMAGEN con LARAVEL 9 <a name="imgdev"></a> [↑](#home)
...
### Enlazar con MYSQL <a name="db"></a> [↑](#home)
...
## En Producción <a name="prod"></a> [↑](#home)
...
```
### COMPOSE <a name="composer"></a> [↑](#home)
...
```
        volumes:
            - ./dump:/docker-entrypoint-initdb.d
```
### PUBLICACIÓN <a name="registro"></a> [↑](#home)
